          ...
          <div className="py-5 space-y-4 relative z-10">
            {isScanning ? (
              ...
              <div className="space-y-3.5">
                ...
                {/* Action Buttons with Outer Border Neon Glow */}
                <div className="flex flex-col space-y-4 pt-2 w-full">
                  {/* Line 1: Camera Capture Button */}
                  <label
                    htmlFor="mobile-camera-file-input"
                    className="rotating-border-box-camera block w-full cursor-pointer group select-none hover:scale-[1.01] active:scale-[0.98] transition-all duration-300"
                    onClick={(e) => {
                      if (isScanning) {
                        e.preventDefault();
                      }
                  ...
                  >
                    ...
                    <div className="relative z-10 w-full py-4 px-5 btn-fancy-camera text-white flex items-center justify-between gap-3">
                      ...
                      <div className="relative z-10 flex-shrink-0 flex items-center">
                        <ChevronRight className="w-5 h-5 text-[#c084fc] group-hover:translate-x-1 transition-transform" />
                      </div>
                    </div>
                  </label>
                  ...
                  <label
                    ...
                    className="rotating-border-box-upload block w-full cursor-pointer group select-none hover:scale-[1.01] active:scale-[0.98] transition-all duration-300"
                    onClick={(e) => {
                      if (isScanning) {
                        e.preventDefault();
                      }
                  ...
                  >
                    ...
                    {/* Inner Sleek Dark Glass Surface */}
                    <div className="relative z-10 w-full py-4 px-5 btn-fancy-upload text-white flex items-center justify-between gap-3">
                      <div className="flex items-center gap-4 relative z-10">
